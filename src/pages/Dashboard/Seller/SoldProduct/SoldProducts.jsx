...
const token = localStorage.getItem('access-token')
    ...
    return (
        <div className=" flex flex-col mt-1 lg:mt-2 md:mt-0">
            ...
            {/*  */}
            <div className=" h-12 md:h-16 grid md:flex md:justify-between lg:grid-cols-10 grid-cols-3  mx-2 px-2 md:px-4 bg-slate-100 rounded-t-lg text-sm md:text-lg font-semibold items-center">
                ...
                <div className="col-span-2 mx-auto lg:col-span-3 flex gap-0.5 md:gap-4  ">
