...
const Categories = () => {
    ...
    return (
        ...
        <div className="h-16  flex justify-between items-center mx-4  p-4 bg-slate-100 rounded-t-lg text-sm md:text-lg  font-semibold ">
            <p className='text-sm md:text-lg lg:text-2xl font-semibold bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 bg-clip-text text-transparent'>Categories</p>
